			...
			<div class="container">
		        ...
		        if (isset($_POST['guncelle'])) {
		            ...
		            if ($uye){
		                ...
		                echo '<script>swal({
		                  title: "Başarılı",
		                  text: "<b>'.$_POST['kadi'].'</b> Adlı Üye Güncellendi",
		                  type: "success",
		                  timer: 2000,
		                  html: "true",
		        ...
		        <form action="" method="post">
		            ...
		            <div class="form-group col-lg-3">
		                ...
		                <input type="text" class="form-control" name="kadi" autofocus="" value="<?php echo $_POST['kadi'] ?>">
		            </div>

		            <div class="form-group col-lg-3">
		                <label style="color:white;">Şifre</label>
		                <input type="text" class="form-control" name="sifre" autofocus="" value="<?php echo $_POST['sifre'] ?>">
		            </div>

		            <div class="form-group col-lg-2">
		                <label style="color:white;">Rütbe</label>
		                <select class="form-control" name="rutbe">
		                	<option value="<?php echo $_POST['rutbe'] ?>" hidden selected>Rütbe</option>
		            ...
		            <div class="form-group col-lg-2">
		                ...
		                <select class="form-control" name="onay">
		                	<option value="<?php echo $_POST['onay'] ?>" hidden selected>Onay</option>
